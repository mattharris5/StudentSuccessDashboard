...

{
    public class Recorder
    {
        ...
        public static void pctVerify(bool rslt, string scrnPct, string stdntName, string vfyPct, string offPct, string pth)
        {
            if (rslt == true)
            {
                if (Convert.ToInt32(offPct) != 1)
                {
                ...
                {
                    TextFileOps.Write(pth, "<b>The percentage '" + scrnPct + "' was displayed for student , '" + stdntName + "'. This final calculated percentage was incorrect, " +
                    "but was within 0.1% of the calculated grade of: " + vfyPct + "</b>", 2);
                }
            }
            else if (rslt == false)
            {
        ...
        public static void imgVerify(bool rslt, string scrnName, string inString, string pth, string getNeg)
        {
            if (rslt == true && (getNeg != "N"))
            {
                TextFileOps.Write(pth, "PASS: The image " + '"' + inString + '"' + " is present on the screen.\r", 1);
                clrValue = 0;
            }
            else if (rslt == false && (getNeg != "N"))
            {
                TextFileOps.Write(pth, "FAIL: The image " + '"' + inString + '"' + " is not present on the screen.\r", -1);
                clrValue = 0;
            }
            else if (rslt == false && (getNeg == "N"))
            {
                TextFileOps.Write(pth, "PASS: The image " + '"' + inString + '"' + " is not present on the screen and is not expected.\r", 1);
                clrValue = 1;
            }
            else if (rslt == true && (getNeg == "N"))
            {
                TextFileOps.Write(pth, "FAIL: The image " + '"' + inString + '"' + " is present on the screen and is not expected.\r", -1);
                clrValue = 0;
            }
        }
        ...
        public static void tooltipVerify(bool rslt, string tipText, string lnkName, string errString, string pth)
        {
            if (rslt == true)
            {
                TextFileOps.Write(pth, "The tooltip '" + tipText + "' was present in the " + lnkName + " link\r\n", 1);
                clrValue = 0;
            }
            else if (rslt == false)
            {
                if (lnkName != "")
                    TextFileOps.Write(pth, "The tooltip '" + tipText + "' was not present in the " + lnkName + " link. "
                        + "The tooltip present was '" + errString + "'\r\n", -1);
                else
                    TextFileOps.Write(pth, "The tooltip '" + tipText + "' was not present in the " + lnkName + " link. "
                        + "There was no tooltip present\r\n", -1);
                clrValue = 0;
            }
        }

        public static void popupVerify(bool rslt, string tipText, string dataText, string rowNum, string colNum, string lnkName, string pth, string getNeg)
        {
            if (rslt == true && (getNeg != "N"))
            {
                TextFileOps.Write(pth, "PASS: The item '" + dataText + "' is present in row " + rowNum + " and column " + colNum + " in the " + lnkName + " standard popup and is expected.\r", 1);
                clrValue = 0;
            }
            else if (rslt == false && (getNeg != "N"))
            {
                TextFileOps.Write(pth, "FAIL: The item '" + dataText + "' is not present in row " + rowNum + " and column " + colNum + " in the " + lnkName + " standard popup and is expected.\r", -1);
                clrValue = 0;
            }
            else if (rslt == false && (getNeg == "N"))
            {
                TextFileOps.Write(pth, "PASS: The item '" + dataText + "' is not present in row " + rowNum + " and column " + colNum + " in the " + lnkName + " standard popup and is not expected.\r", 1);
                clrValue = 0;
            }
            else if (rslt == true && (getNeg == "N"))
            {
                TextFileOps.Write(pth, "FAIL: The item '" + dataText + "' is present in row " + rowNum + " and column " + colNum + " in the " + lnkName + " standard popup and is not expected.\r", -1);
                clrValue = 0;
            }
        }
