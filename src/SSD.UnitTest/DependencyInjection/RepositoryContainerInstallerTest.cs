...
{
    [TestClass]
    public class RepositoryContainerInstallerTest
    {
        private RepositoryContainerInstaller Target { get; set; }
        private IWindsorContainer Container { get; set; }

        [TestInitialize]
        public void InitializeTest()
        {
            Target = new RepositoryContainerInstaller();
        ...
        public void GivenRegistrationsInstalled_ThenRegistrationsExist_AndAllHandlersRegistered()
        {
            ...
            var actualHandlers = Container.GetHandlersFor(typeof(IRepositoryContainer));
        ...
        {
            var invalidHandlers = Container.GetHandlersFor(typeof(IRepositoryContainer))
        ...
        {
            var allTypes = typeof(IRepositoryContainer).Assembly.GetPublicClasses(c => c.Is<IRepositoryContainer>());
            var actualTypes = Container.GetImplementationTypesFor(typeof(IRepositoryContainer));
